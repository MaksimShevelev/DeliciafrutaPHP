<?php
    $tipoSeleccionada = $_GET['tipo'];
    $productos = (new Producto())->catalogo_x_categoria($tipoSeleccionada);
?>


<h1 class="text-center my-5"><?= $productos[0]->getCategoria() ?></h1>
<div class="row">
    <?php foreach ($productos as $producto) { ?>

    <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="card mb-3">
            <img class="card-img-top rounded-0" src="img/covers/<?= $producto->getImagen() ?>">
            <div class="card-body">
